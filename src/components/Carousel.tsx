    ...
    <>
      ...
      <div className="relative h-[30rem] w-full">
        ...
        <div className="absolute top-44 left-0 right-0">
          <IoChevronBackSharp
            className="absolute right-1/2 h-32 w-32 -translate-x-[32rem] text-greyblack transition-transform hover:scale-110 cursor-pointer"
            onClick={() => {
              setActiveIndex(
          ...
          <IoChevronForwardSharp
            className="absolute left-1/2 h-32 w-32 translate-x-[32rem] text-greyblack transition-transform hover:scale-110 cursor-pointer"
            onClick={() => {

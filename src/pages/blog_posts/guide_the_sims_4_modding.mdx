...
A .ts4script file is an archive that contains a .PY script (*python*). It is commonly used to add or modify interactions, animations, and menus in the game. 
...
(*[cough, cough](https://www.reddit.com/r/Sims4/comments/11e95e6/goth_family_remake/)*) that you'd love to have in your game, you'll need more than just custom content (CC) to bring them into
...
especially script mods after bigger game updates. (*You'll also have to re-enable Custom Content and Mods in the game options menu after updates, the game will notify you when they have been 
disabled.*)
